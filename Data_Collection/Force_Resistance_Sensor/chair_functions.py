...
def create_directories() -> str:
    ...
    current_path = os.path.join(current_path,'Force_Resistance_Sensor')
    #Create chair recordings folder
    raw_data = os.path.join(current_path,'Chair_Raw_Data')
    if(os.path.isdir(raw_data)):
        pass
    else:
        os.mkdir(raw_data)
    #Create folder for the converted csv files
    transposed_data = os.path.join(current_path,'Chair_CSV_Data')
    ...
    edited_recordings = os.path.join(current_path,'Chair_Edited_Recordings')
