...
def create_tr_tst_dfs(tr_set,tr_path,tst_set,tst_path,cl1,cl2,cl3,cl4,cl1_name,cl2_name,cl3_name,cl4_name):
    list_of_dataframes = []
    for f in tst_set:
    ...
    tst_df = tst_df.loc[(tst_df['Label'] == cl1 ) | (tst_df['Label'] == cl2) | (tst_df['Label'] == cl3) | (tst_df['Label'] == cl4)]
    ...
    tr_df = tr_df.loc[(tr_df['Label'] == cl1 ) | (tr_df['Label'] == cl2) | (tr_df['Label'] == cl3) | (tr_df['Label'] == cl4)]

    #Show the training set class distribution
    show_class_distribution(tr_df,cl1,cl2,cl3,cl4,cl1_name,cl2_name,cl3_name,cl4_name)

    X_train, y_train = tr_df.iloc[:,:-1], tr_df.iloc[:,-1]
    target_count = tr_df.Label.value_counts()

    min_n_samples = min(target_count[cl1], target_count[cl2], target_count[cl3], target_count[cl4])

    if target_count[cl1] != target_count[cl2] != target_count[cl3] != target_count[cl4]:
        os = RandomUnderSampler(sampling_strategy={cl1:min_n_samples, cl2:min_n_samples, cl3:min_n_samples, cl4:min_n_samples})
        ...
        show_class_distribution(resampled_df,cl1,cl2,cl3,cl4,cl1_name,cl2_name,cl3_name,cl4_name)
...
def show_class_distribution(X_train,cl1,cl2,cl3,cl4,cl1_name,cl2_name,cl3_name,cl4_name):
...
if __name__ == '__main__':
    ...
    class_labels = [str(class1),str(class2),str(class3),str(class4)]
    target_names = [class1_name, class2_name, class3_name, class4_name]
